...
NPL.load("(gl)script/nplprotobuf/protobuf/wire_format.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/type_checkers.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/encoder.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/decoder.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/listener.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/containers.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/descriptor.lua")
NPL.load("(gl)script/nplprotobuf/protobuf/text_format.lua")
        ...
        for field, value in message_meta._member.ListFields(self) do
            if field.cpp_type == FieldDescriptor.CPPTYPE_MESSAGE then
                if field.is_extension then
					-- fix io.format nil index exception
